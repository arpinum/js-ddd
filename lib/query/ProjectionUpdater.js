...
const co = require('co');
const {TypedEventStore, TypedLogger, TypedProjectionUpdater} = require('../types');
...
function Factory(creation) {
  ...
  let options = Object.assign({}, {log: Logger({fileName: __filename}), rawOptions});
...
module.exports = t.func(Creation, TypedProjectionUpdater).of(Factory);
