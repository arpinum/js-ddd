...
describe('The sanitize module', () => {
  context('about integer', () => {
    ...
    it('should fail if the property is defined but cannot be converted', () => {
      ...
      conversion.should.throw(
        FunctionalError,
        'The property int is not a valid integer'
      );
    });
  });
  ...
  context('about boolean', () => {
    ...
    it('should fail if the property is defined but cannot be converted', () => {
      ...
      conversion.should.throw(
        FunctionalError,
        'The property bool is not a valid boolean'
      );
    });
  });
  ...
  context('about date', () => {
    ...
    it('should do nothing if the property is null', () => {
      let object = { nothing: 'todo', date: null };

      let result = sanitize(object)
        .convert('date')
        .toDate();

      result.should.deep.equal({ nothing: 'todo', date: null });
    });
    ...
    it('should fail if the property is defined but cannot be converted', () => {
      ...
      conversion.should.throw(
        FunctionalError,
        'The property theDate is not a valid date'
      );
    });
  });
});
