...
describe('The memory event store', () => {
  ...
  it('should find events from a aggregate', () => {
    eventStore.events = [
      {id: 'event1', aggregateRoot: {id: 'wrongAggregate', type: 'wrongType'}},
      {id: 'event2', aggregateRoot: {id: 'rightAggregate', type: 'rightType'}},
      {id: 'event3', aggregateRoot: {id: 'rightAggregate', type: 'wrongType'}},
      {id: 'event4', aggregateRoot: {id: 'rightAggregate', type: 'rightType'}},
      {id: 'event5', aggregateRoot: {id: 'wrongAggregate', type: 'wrongType'}}
    ];
