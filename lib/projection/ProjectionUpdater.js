...
class ProjectionUpdater {
  ...
  _retrieveLastEventId() {
    if (!this._lastEventId) {
      return this._projectionTracker.getLastProcessedEventId(this.projectionName);
    }
  ...
  _updateLastEventProcessed() {
    if (this._lastEventId) {
      return this._projectionTracker.updateLastProcessedEventId(this.projectionName, this._lastEventId);
    }
    return Promise.resolve();
  }
